...
public class LOGIN_Clientes extends javax.swing.JFrame {
    ...
    ClientesDAO ldao = new ClientesDAO();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(250, 229, 136));
        ...
        txt_usuario.setBackground(new java.awt.Color(250, 229, 136));
        ...
        txt_password.setBackground(new java.awt.Color(250, 229, 136));
        ...
        Pnl_barraSuperior.setBackground(new java.awt.Color(250, 229, 136));
        ...
        Pnl_salir.setBackground(new java.awt.Color(250, 229, 136));
    ...
    private void Btn_salirMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_salirMouseExited
        procesoRepetido.pintarComponente("cLogin", Pnl_salir);
    ...
    private void Btn_iniciarSesionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_iniciarSesionMouseClicked
        ...
        if (newPassword.equals(login.getPassword())) {
            ...
            procesoRepetido.accionErronea("¡ERROR!", "No haz podido acceder debido a que tu usuario o contraseña estan erroneos, verificalo e intenta nuevamente.");
        }
