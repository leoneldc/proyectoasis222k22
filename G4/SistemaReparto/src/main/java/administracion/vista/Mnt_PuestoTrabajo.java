...
public class Mnt_PuestoTrabajo extends javax.swing.JInternalFrame {
    ...
    public void diseño() {
        setTitle("Mantenimiento de Puestos de Trabajo");
    ...
    private void cargarDatos(String query) {
        ProcesosRepetidos procesosr = new ProcesosRepetidos();
        PuestosTrabajoDAO.codigoPuestoT = query;
        PuestosTrabajoDAO.nombrePuestoT = query;
            ...
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.isEmptyTxa(Txt_descripcion)) {
                    if (procesosr.isSelectedRbt(Rb_activo, Rb_inactivo)) {
                        puestoT.setId(Txt_id.getText());
                        puestoT.setNombre(Txt_nombre.getText());
                        puestoT.setDescripcion(Txt_descripcion.getText());
                        if (Rb_activo.isSelected()) {
                            puestoT.setEstado("1");
                        } else {
                            puestoT.setEstado("0");
                        }
                        puestoTDAO.update(puestoT);
