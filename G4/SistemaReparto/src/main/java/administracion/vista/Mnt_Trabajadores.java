...
public class Mnt_Trabajadores extends javax.swing.JInternalFrame {
    ...
    private void limpiar() {
        procesosr.limpiarTxf(Txt_id, Txt_idPT, Txt_nombrePT, Txt_nombre, Txt_apellido, Txt_user, Txt_password, Txt_email, Txt_busqueda);
    ...
    private void cargarDatos(String query) {
        ProcesosRepetidos procesosr = new ProcesosRepetidos();
        TrabajadoresDAO.codigoTrabajador = query;
        TrabajadoresDAO.nombreTrabajador = query;
    ...
    private void initComponents() {
        ...
        Lbl_idPT = new javax.swing.JLabel();
        Txt_idPT = new javax.swing.JTextField();
        Btn_listadoPT = new javax.swing.JButton();
        ...
        Txt_nombrePT = new javax.swing.JTextField();
        ...
        Lbl_idPT.setFont(new java.awt.Font("Ubuntu", 1, 14)); // NOI18N
        Lbl_idPT.setForeground(new java.awt.Color(255, 255, 255));
        Lbl_idPT.setText("ID PUESTO DE T:");

        Txt_idPT.setBackground(new java.awt.Color(163, 177, 138));
        Txt_idPT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        Txt_idPT.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(88, 129, 87)));

        Btn_listadoPT.setText("CARGAR");
        Btn_listadoPT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Btn_listadoPTActionPerformed(evt);
            }
        });
        ...
        Txt_nombrePT.setEditable(false);
        Txt_nombrePT.setBackground(new java.awt.Color(163, 177, 138));
        Txt_nombrePT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
                ...
                .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                        .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(Lbl_idPT, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(21, 21, 21)
                        .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Pnl_ingresoDatosLayout.createSequentialGroup()
                                .addComponent(Txt_idPT)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(Btn_listadoPT))
                            .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                            ...
                            .addComponent(Txt_nombrePT, javax.swing.GroupLayout.Alignment.TRAILING))))
        ...
        Pnl_ingresoDatosLayout.setVerticalGroup(
            ...
            .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Lbl_idPT)
                    .addComponent(Txt_idPT, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Btn_listadoPT)
                    .addComponent(jButton1))
                .addGap(18, 18, 18)
                .addComponent(Txt_nombrePT, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21)
                .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Lbl_nombre)
    ...
    private void Tbl_DatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tbl_DatosMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            Txt_idPT.setText(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 1).toString());
            Txt_nombre.setText(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 2).toString());
            Txt_apellido.setText(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 3).toString());
            Txt_user.setText(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 4).toString());
            String descontraseña = Hash.getString(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 5).toString());
            Txt_password.setText(descontraseña);
            Txt_email.setText(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 6).toString());
            if (Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 8).toString().equals("activo")) {
    ...
    private void Btn_modificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_modificarMouseClicked
        if (procesosr.isEmptyTxf(Txt_id, Txt_nombre, Txt_nombrePT, Txt_apellido, Txt_user, Txt_password, Txt_email)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.isSelectedRbt(Rb_activo, Rb_inactivo)) {
                    if (procesosr.ValidarEmail(Txt_email.getText())) {
                        trabajadores.setIdTrabaajdor(Txt_id.getText());
                        trabajadores.setIdPuestoT(Txt_idPT.getText());
                        trabajadores.setNombre(Txt_nombre.getText());
                        trabajadores.setApellido(Txt_apellido.getText());
                        trabajadores.setUsuario(Txt_user.getText());
                        String passwordEncry = Hash.getMD5(Txt_password.getText());
                        trabajadores.setPassword(passwordEncry);
                        trabajadores.setEmail(Txt_email.getText());
                        if (Rb_activo.isSelected()) {
                            trabajadores.setEstado("1");
                        }
                        if (Rb_inactivo.isSelected()) {
                            trabajadores.setEstado("0");
                        }
                        trabajadoresDAO.update(trabajadores);
                        funcBitacora.GuardarBitacora("MODIFICAR", idApp);
                        cargarDatos("");
                        procesosr.accionExitosa("Modificación Exitosa", "Se ha modificado el trabajador: \"" + Txt_nombre.getText() + " " + Txt_apellido.getText() + "\" correctamente");
                        limpiar();
                    }
                }
            }
    ...
    private void Btn_eliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_eliminarMouseClicked
        if (procesosr.isEmptyTxf(Txt_id)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.confirmarEliminación("el Trabajador# " + Txt_id.getText())) {
                    trabajadores.setIdTrabaajdor(Txt_id.getText());
                    trabajadoresDAO.delete(trabajadores);
                    funcBitacora.GuardarBitacora("ELIMINAR", idApp);
                    cargarDatos("");
                    procesosr.accionExitosa("Eliminación Exitosa", "Se ha eliminado el trabajador #" + Txt_id.getText() + " correctamente");
                    limpiar();
                }
            }
        }
    ...
    private void Btn_guardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_guardarMouseClicked
        if (procesosr.isEmptyTxf(Txt_id, Txt_nombrePT, Txt_nombre, Txt_apellido, Txt_user, Txt_password, Txt_email)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.isSelectedRbt(Rb_activo, Rb_inactivo)) {
                    if (procesosr.ValidarEmail(Txt_email.getText())) {
                        trabajadores.setIdTrabaajdor("0");
                        trabajadores.setIdPuestoT(Txt_idPT.getText());
                        trabajadores.setNombre(Txt_nombre.getText());
                        trabajadores.setApellido(Txt_apellido.getText());
                        trabajadores.setUsuario(Txt_user.getText());
                        ...
                        trabajadoresDAO.insert(trabajadores);
                        funcBitacora.GuardarBitacora("GUARDAR", idApp);
                        cargarDatos("");
                        procesosr.accionExitosa("Registro Exitoso", "Se ha registrado el trabajador: \"" + Txt_nombre.getText() + " " + Txt_apellido.getText() + "\" correctamente");
                        limpiar();
                    }
                }
            }
    ...
    private void Btn_listadoPTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_listadoPTActionPerformed
        if (procesosr.isNumeric(Txt_idPT)) {
            PuestosTrabajo puestoT = new PuestosTrabajo();
            PuestosTrabajoDAO puestoTDAO = new PuestosTrabajoDAO();
            puestoT.setId(Txt_idPT.getText());
            puestoT = puestoTDAO.selectV(puestoT);
            if (puestoT.getNombre() == null) {
                JOptionPane.showMessageDialog(null, "PUESTO DE TRABAJO NO EXISTE");
            } else {
                if (puestoT.getEstado().equals("1")) {
                    Txt_nombrePT.setText(puestoT.getNombre());
                } else {
                    JOptionPane.showMessageDialog(null, "PUESTO DE TRABAJO DESHABILITADO");
                }
            }
        }
    ...
    private javax.swing.JButton Btn_listadoPT;
    ...
    private javax.swing.JLabel Lbl_idPT;
    ...
    private javax.swing.JTextField Txt_idPT;
    private javax.swing.JTextField Txt_nombre;
    private javax.swing.JTextField Txt_nombrePT;
