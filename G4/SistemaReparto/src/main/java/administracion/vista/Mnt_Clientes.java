...
public class Mnt_Clientes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        Lbl_t.setFont(new java.awt.Font("Ubuntu", 1, 14)); // NOI18N
        Lbl_t.setForeground(new java.awt.Color(255, 255, 255));
        Lbl_t.setText("TELEFONO:");

        Txt_telefono.setBackground(new java.awt.Color(163, 177, 138));
        Txt_telefono.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        Txt_telefono.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(88, 129, 87)));
    ...
    private void Btn_modificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_modificarMouseClicked
        if (procesosr.isEmptyTxf(Txt_id, Txt_nombre, Txt_password, Txt_email, Txt_telefono)) {
    ...
    private void Btn_eliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_eliminarMouseClicked
        if (procesosr.isEmptyTxf(Txt_id)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.confirmarEliminación("el Cliente# " + Txt_id.getText())) {
                    clientes.setId(Txt_id.getText());
                    clientesDAO.delete(clientes);
                    funcBitacora.GuardarBitacora("ELIMINAR", idApp);
                    cargarDatos("");
                    procesosr.accionExitosa("Eliminación Exitosa", "Se ha eliminado el cliente #" + Txt_id.getText() + " correctamente");
                    limpiar();
                }
            }
        }
