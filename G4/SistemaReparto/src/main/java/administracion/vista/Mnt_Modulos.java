...
import administracion.modelo.ModulosDAO;
import administracion.modelo.UsuarioAplicacionDAO;
import java.util.List;

public class Mnt_Modulos extends javax.swing.JInternalFrame {
    ...
    private void cargarDatos(String busqueda) {
        ProcesosRepetidos procesosr = new ProcesosRepetidos();
        ModulosDAO.codigoModulo = busqueda;
        ModulosDAO.nombreModulo = busqueda;
        ...
        ModulosDAO modulosDAO = new ModulosDAO();
        List<Modulos> listaModulos = modulosDAO.select();
        for (Modulos listaModulo : listaModulos) {
            datos[0] = listaModulo.getId();
            datos[1] = listaModulo.getNombre();
            datos[2] = listaModulo.getDescripcion();
            if (listaModulo.getEstado().equals("1")) {
                datos[3] = "activo";
            } else {
                datos[3] = "inactivo";
            }
    ...
    private void initComponents() {
        ...
        bg_grupoEstados = new javax.swing.ButtonGroup();
        ...
        bg_grupoEstados.add(Rb_activo);
        Rb_activo.setText("ACTIVO");

        bg_grupoEstados.add(Rb_inactivo);
        Rb_inactivo.setText("INACTIVO");

        bg_grupoEstados.add(Rb_limpieza);
            ...
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.isEmptyTxa(Txt_descripcion)) {
                    if (procesosr.isSelectedRbt(Rb_activo, Rb_inactivo)) {
                        modulos.setId(Txt_id.getText());
                        modulos.setNombre(Txt_nombre.getText());
                        modulos.setDescripcion(Txt_descripcion.getText());
                        ...
                        cargarDatos("");
                        procesosr.accionExitosa("Modificación Exitosa", "Se ha modificado el modulo: \"" + Txt_nombre.getText() + "\" correctamente");
                        limpiar();
                    }
                }
            }
        ...
        if (procesosr.isEmptyTxf(Txt_id)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.confirmarEliminación("el Modulo # " + Txt_id.getText())) {
                    ...
                    cargarDatos("");
                    procesosr.accionExitosa("Eliminación Exitosa", "Se ha eliminado el modulo # " + Txt_id.getText() + " correctamente");
                    limpiar();
                }
            }
        }
            ...
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.isEmptyTxa(Txt_descripcion)) {
                    if (procesosr.isSelectedRbt(Rb_activo, Rb_inactivo)) {
                        ...
                        modulosDAO.insert(modulos);
                        funcBitacora.GuardarBitacora("GUARDAR", idApp);
                        cargarDatos("");
                        procesosr.accionExitosa("Regristro Exitoso", "Se ha registrado el modulo: \"" + Txt_nombre.getText() + "\" correctamente");
                        limpiar();
                    }
                }
            }
    ...
    private javax.swing.ButtonGroup bg_grupoEstados;
